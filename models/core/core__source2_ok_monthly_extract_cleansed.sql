...
with final as (
    select 
        ...
        trim(replace(split_part(type_license,'-',2),'K',''))::numeric as license_number,
        ...
        aa4,
        company,
        trim(split_part(license_monitoring_since,'{{ license_monitoring_since_string }}',2))::date as license_issued
